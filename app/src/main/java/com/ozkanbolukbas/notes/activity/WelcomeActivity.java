...
public class WelcomeActivity extends BaseActivity implements NoteAdapter.NoteClickListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.action_public) {
            Intent intent = new Intent(this, PublicnotesActivity.class);
    ...
    private void fetchNotes(boolean forceRefresh) {
        ...
        getApi().getNotes().enqueue(new SimpleCallback<List<Note>>() {
            @Override
